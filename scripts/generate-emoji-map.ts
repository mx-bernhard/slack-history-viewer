...
import { slackToUnicodeMap } from './emojis-raw.ts';
...
interface EmojiDataSourceEntry {
  ...
  skin_variations?: {
    [key: string]: EmojiDataSourceEntry; // Skin tones reference the base structure
  };
  obsoletes?: string;
  obsoleted_by?: string;
}
...
async function generateMap() {
  ...
  const finalEmojiMap: { [slackName: string]: string } = {};
  ...
  const tsContent = `// Generated by scripts/generate-emoji-map.ts
